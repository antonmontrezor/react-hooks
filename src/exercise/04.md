...
It's good practice not to create a state variable all the time and check if we could have derived state variables. It's been a great exercise to wrap my head around the state management for the game.
